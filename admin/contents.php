...
<section class="contents">
   ...
   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">create new video content</h3>
      <a href="add_content" class="btn">add video content</a>
   </div>
   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">create new file content</h3>
      <a href="add_contents" class="btn">add file content</a>
   </div>
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_content?get_id=<?= $video_id; ?>" class="option-btn">update</a>
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('delete this video?');" name="delete_video">
         </form>
         <a href="view_content?get_id=<?= $video_id; ?>" class="btn">view content</a>
      </div>
   <?php
         }
      }else{
