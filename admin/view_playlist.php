   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist?get_id=<?= $playlist_id; ?>" class="option-btn">update playlist</a>
...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content?get_id=<?= $video_id; ?>" class="btn">watch video</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">no videos added yet! <a href="add_content" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
      }
   ?>
